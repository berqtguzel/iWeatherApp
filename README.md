...
```bash
 npm install       komutunu kullanarak gerekli dosyaları yükleyin
 yarn start        komutunu kullanarak web uygulamasını çalıştırın
```

## Projenin Resimleri

<img width="1680" alt="Ekran Resmi 2024-04-21 20 35 55" src="https://github.com/berqtguzel/weather-app/assets/95329609/7302e354-dd11-462f-bcde-56496e16fc9b">
...
```
## API
Axios kullanılarak api çekilmiştir 
